			...
			<div class="details">
				<div class="details-l fl">
					...
					<div class="details-l-02">
						...
						<div class="details-l-02-r">{{details.users?details.users.nickname:''}}</div>
					</div>
					<div class="details-l-02">
...
<script>
	...
	export default {
		...
		methods: {
			...
			post_details() {
				var that = this;
				orderModel.get_one_order(this.mid).then(res=>{
			...
			courier_sub() {
				...
				this.http.post_show("/order/fahuo", arr).then(res => {
